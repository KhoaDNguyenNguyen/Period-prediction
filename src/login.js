...
if (jwt) {
  ...
  return;   // không chạy form login nữa
}
  ...
  document.addEventListener('DOMContentLoaded', () => {
    /* Toggle giữa Login / Register panel */
    ...
    loginForm?.addEventListener('submit', async e => {
      ...
      try {
        ...
        localStorage.setItem('loggedIn', 'true');    // đặt cờ đã login
        // window.location.href = './survey.html';
